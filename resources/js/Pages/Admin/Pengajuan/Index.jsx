                                ...
                                {pengajuan?.data?.length > 0 ? pengajuan.data.map(p => (
                                    <tr key={p.id} className="hover:bg-dark-surface/50 transition-colors">
                                        ...
                                        <td className="px-4 py-2.5 text-right">
                                            <Link href={`${prefix}/${p.id}`} className="btn-ghost btn-sm">
                                                <Eye size={13} /> Detail
                                            </Link>
                                        </td>
                                    </tr>
                                )) : (
                                    <tr><td colSpan={6} className="px-4 py-12 text-center text-sm text-text-secondary">Tidak ada pengajuan ditemukan.</td></tr>
                                )}
                            </tbody>
                        </table>
                    </div>
